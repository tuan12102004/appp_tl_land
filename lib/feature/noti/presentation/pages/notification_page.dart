...
class _NotificationPageState extends State<NotificationPage> {
  List<NotificationEntity> notifications = List.generate(
    ...
    (index) => NotificationEntity(
      ...
      content: "$index Bạn đã đăng ký tài khoản thành công, hãy sử dụng những tính năng mới. Lorem ipsum dolor sit amet consectetur. Erat ornare massa tincidunt vitae viverra",
              ...
              return [
                ...
                PopupMenuItem(
                  ...
                  child: CustomAdaptiveButton(
                    ...
                    preffixWidget: Icon(
                      Icons.delete,
                      color: IconColors.iconErrorPrimary,
                      size: 24.sp
                    ),
                    onPressed: (){
                      // TODO: Delete all noti
