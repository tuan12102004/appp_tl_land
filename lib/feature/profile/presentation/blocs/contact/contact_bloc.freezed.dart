...
mixin _$ContactEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ContactEvent);
  }
...
extension ContactEventPatterns on ContactEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    final _that = this;
    switch (_that) {
      case GetContacts() when getContacts != null:
        return getContacts(_that);
      case _:
        return orElse();
    }
  }
...
class GetContacts implements ContactEvent {
  const GetContacts();
...
mixin _$ContactState {
  ...
  int get hashCode => Object.hash(runtimeType, isLoading,
      const DeepCollectionEquality().hash(contacts), failure);

  @override
  String toString() {
    return 'ContactState(isLoading: $isLoading, contacts: $contacts, failure: $failure)';
  }
}
...
abstract mixin class $ContactStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, List<ContactEntity> contacts, Failure? failure});
}
...
extension ContactStatePatterns on ContactState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            bool isLoading, List<ContactEntity> contacts, Failure? failure)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ContactState() when $default != null:
        return $default(_that.isLoading, _that.contacts, _that.failure);
      case _:
        return orElse();
    }
  }
...
class _ContactState implements ContactState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading,
      const DeepCollectionEquality().hash(_contacts), failure);
