...
class RequestSubmissionHistory extends StatefulWidget {
  ...
  @override
  State<RequestSubmissionHistory> createState() =>
      _RequestSubmissionHistoryState();
}
...
class CustomListCard extends StatelessWidget {
  const CustomListCard({super.key, required this.now});
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    "Ngày gửi: ${now.day}/${now.month}/${now.year} ",
                    style: TextStyle(
                      fontSize: 15.sp,
