        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: BorderColors.borderInputFieldDefault.withValues(alpha: 0.2),
              ),
            ),
            child: Row(
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.titleMedium?.copyWith(
                    ...
                    color: selectedValue == null
                      ? TextColors.textDefaultTertiary.withValues(alpha: 0.3) // mờ khi chưa chọn
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(12.r),
                        color: isSelected
                          ? BackgroundColors.backgroundComboBoxMenuItemOnselected
                          : Colors.transparent,
                      ),
                      child: Row(
                        children: [
                          isSelected ? Icon(Icons.check, color: IconColors.iconBrandOnbrand, size: 16.sp,) : SizedBox(),
                          SizedBox(width: 2.w),
                          Text(
                            ...
                            style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                              ...
                              fontSize: 15.sp,
                              color: isSelected 
                                ? TextColors.textComboBoxMenuItemOnselected
                                : TextColors.textComboBoxMenuItemDefault
                            ),
                          ),
                        ],
                      ),
